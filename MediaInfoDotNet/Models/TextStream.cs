...
namespace MediaInfoDotNet.Models
{
	...
	public sealed class TextStream : BaseStreamCommons
	{
		...
		///<summary>The bitrate(s) of this stream, in bits per second</summary>
		[Description("The bitrate(s) of this stream, in bits per second"), Category("VideoAudioTextCommon")]
		public float BitRate { get { return this.bitRate; } }
